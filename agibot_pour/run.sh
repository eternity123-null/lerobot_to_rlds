...
TFDS_DATA_DIR=/inspire/ssd/project/embodied-intelligence/public/jintian/WAIC/UniDomain/datasets/RLDS tfds build --overwrite > build.log 2>&1
TFDS_DATA_DIR=/inspire/hdd/project/robot-decision/public/Unidomain/datasets/tmprlds tfds build --overwrite > build.log 2>&1